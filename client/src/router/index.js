...
export const asyncRoutes = [
  ...
  },
  {
    ...
    children: [
      {
        path: 'list',
        component: () => import('@/views/fundslist'),
        name: 'FundsList',
        meta: { title: '基金列表', icon: 'list' },
        hidden: false
      },
      {
        //path: 'detail/:id(\\d+)',
        ...
        name: 'detail',
        meta: { title: '基金详情', noCache: true, activeMenu: '/funds/list' },
        hidden: true
      },
  ...
  },
  {
    ...
    children: [{
      ...
      meta: { title: '个人中心', icon:'example', perms:['usercenter'] },
      hidden: false,
    }]
  },
  ...
  {
    path:'/trendPage',
    component: () => import('@/views/chart/TrendPage'),
    hidden:true
  }
]
